-- Example Rspamd verdict exporter. Adjust paths, instance and the two explicit
-- policy symbols. The action is recorded but never determines classification.
...
local output = '/var/log/rspamd/tlsgate-verdicts.jsonl'
local instance = 'mx-public'
local spam_symbol = 'TLSGATE_CLASS_SPAM'
local ham_symbol = 'TLSGATE_CLASS_HAM'
